 ...
 */
public class TopPaidFragment3 extends Fragment {
    private final static String STORETEXT="storetext3.txt";
    EditText txtEditor;
    Button SaveNotes;


    public TopPaidFragment3() {
...
//This fragment is for saving the Module Notes
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview= inflater.inflate(R.layout.fragment_top_paid_fragment3, container, false);
        txtEditor= (EditText) rootview.findViewById(R.id.ednotes3);
        SaveNotes=(Button)rootview.findViewById(R.id.NotesButton3);
