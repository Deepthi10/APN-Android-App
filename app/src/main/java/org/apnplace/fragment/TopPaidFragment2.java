 ...
 */
public class TopPaidFragment2 extends Fragment {
    private final static String STORETEXT="storetext2.txt";
    EditText txtEditor;
    Button SaveNotes;

    public TopPaidFragment2() {
...
//This fragment is for saving the Module Notes
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview= inflater.inflate(R.layout.fragment_top_paid_fragment2, container, false);
        txtEditor= (EditText) rootview.findViewById(R.id.ednotes2);
        SaveNotes=(Button)rootview.findViewById(R.id.NotesButton2);
